...
- The isolated fixture invoked the real Codex CLI and interrupted production registration after `.registration.stage` was durably written while `publication.json` was absent. The exact same recovery ID then resumed successfully without another Codex invocation: call count remained 2 before and after retry.
...
- Evidence: `/private/tmp/blenderdesign-closeout-20260922-27x0hxjj/final-fix/codex-stage/result.json`; log SHA-256 `1641291aa6bd6d5feae8120c01c20236a05d7451045c371e890e62a976b71bc2`.

Actual isolated owned-profile installer version-only install/verify/finalize:

- A fresh mode-0700 owned HOME first installed and finalized reviewed Task 3 candidate `a4bf15db6b565b08de37b76439b96d89e7e7add3` (`1.0.0+codex.20260922175350`), then upgraded from clean detached candidate `6ad6638e77f0cebd226172f793301112bdd7322f` (`1.0.0+codex.20260922221552`). Both registrations used real Codex and Blender 5.2.0 LTS; both verified 26 MCP tools and read-only Blender access, and both finalizations completed. Candidate version-only install reported `no_op=true` with the same receipt and bundle `1.0.0+4309a39646e6.p912ed3244261`; finalization removed the old plugin cache version.
...
- Structured evidence: `/private/tmp/blenderdesign-closeout-20260922-27x0hxjj/final-fix/profile-upgrade-final/version-only-summary.json`; real stage logs `/private/tmp/blenderdesign-closeout-20260922-27x0hxjj/final-fix/profile-upgrade-final/old-D.log` and `final-6ad.log` have SHA-256 `8e8cf296c3faa5f7fb6eee7f2d5da78bb40d51dd2d728a9ee8e7473c5bd614b1` and `725b4724b998d6d0bee57061949f420c7f083e48b325071fc673721d8fe8c952`.
