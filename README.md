...
| 资产验收 | schema v2 的 M0/M1 可信核心及有限 M2 Native/M3 GLB worker | 只覆盖已声明的静态范围，不用于通用资产自动发布放行 |
...
acceptance/                    checkout-only 的 schema v2 资产验收核心与 Native/GLB worker，不进入 wheel/sdist
